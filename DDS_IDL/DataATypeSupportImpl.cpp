...
void gen_find_size(const TestA::DataA& stru, size_t& size, size_t& padding)
{
  ...
  gen_find_size(stru.dataSeq, size, padding);
}
...
struct MetaStructImpl<TestA::DataA> : MetaStruct {
  ...
  {
    static const char* names[] = {"pos", "name", "length", "dataSeq", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "dataSeq") == 0) {
      return &static_cast<const T*>(stru)->dataSeq;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct TestA::DataA)");
  }
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "dataSeq") == 0) {
      static_cast<T*>(lhs)->dataSeq = *static_cast<const CORBA::CharSeq*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct TestA::DataA)");
  }
...
void gen_find_size(const TestA::DataB& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.latitude);
  if ((size + padding) % 8) {
    padding += 8 - ((size + padding) % 8);
  }
  size += gen_max_marshaled_size(stru.longitude);
  if ((size + padding) % 8) {
    padding += 8 - ((size + padding) % 8);
  }
  size += gen_max_marshaled_size(stru.altitude);
}
...
namespace TestA {
::DDS::DataWriter_ptr DataBTypeSupportImpl::create_datawriter()
{
  typedef OpenDDS::DCPS::DataWriterImpl_T<DataB> DataWriterImplType;
  ::DDS::DataWriter_ptr writer_impl = ::DDS::DataWriter::_nil();
  ACE_NEW_NORETURN(writer_impl,
                   DataWriterImplType());
  return writer_impl;
}
::DDS::DataReader_ptr DataBTypeSupportImpl::create_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<DataB> DataReaderImplType;
  ::DDS::DataReader_ptr reader_impl = ::DDS::DataReader::_nil();
  ACE_NEW_NORETURN(reader_impl,
                   DataReaderImplType());
  return reader_impl;
...
#ifndef OPENDDS_NO_MULTI_TOPIC
::DDS::DataReader_ptr DataBTypeSupportImpl::create_multitopic_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<DataB> DataReaderImplType;
  typedef OpenDDS::DCPS::MultiTopicDataReader_T<DataB, DataReaderImplType> MultiTopicDataReaderImplType;
  ::DDS::DataReader_ptr multitopic_reader_impl = ::DDS::DataReader::_nil();
  ACE_NEW_NORETURN(multitopic_reader_impl,
                   MultiTopicDataReaderImplType());
  return multitopic_reader_impl;
...
#endif /* !OPENDDS_NO_MULTI_TOPIC */
#ifndef OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE
const OpenDDS::DCPS::MetaStruct& DataBTypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<DataB>();
}
#endif /* !OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */
bool DataBTypeSupportImpl::has_dcps_key()
{
  return TraitsType::gen_has_key ();
}
const char* DataBTypeSupportImpl::default_type_name() const
{
  return TraitsType::type_name();
}
DataBTypeSupport::_ptr_type DataBTypeSupportImpl::_narrow(CORBA::Object_ptr obj)
{
  return TypeSupportType::_narrow(obj);
}
}
...
template<>
struct MetaStructImpl<TestA::DataB> : MetaStruct {
  typedef TestA::DataB T;
  ...
  Value getValue(const void* stru, const char* field) const
  {
    const TestA::DataB& typed = *static_cast<const TestA::DataB*>(stru);
    ...
    ACE_UNUSED_ARG(typed);
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct TestA::DataB)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct TestA::DataB");
  }
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "latitude") == 0) {
      return make_field_cmp(&T::latitude, next);
    }
    if (std::strcmp(field, "longitude") == 0) {
      return make_field_cmp(&T::longitude, next);
    }
    if (std::strcmp(field, "altitude") == 0) {
  ...
  const char** getFieldNames() const
  {
    static const char* names[] = {"id", "name", "latitude", "longitude", "altitude", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "latitude") == 0) {
      return &static_cast<const T*>(stru)->latitude;
    }
    if (std::strcmp(field, "longitude") == 0) {
      return &static_cast<const T*>(stru)->longitude;
    }
    if (std::strcmp(field, "altitude") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "latitude") == 0) {
      static_cast<T*>(lhs)->latitude = *static_cast<const CORBA::Double*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "longitude") == 0) {
      static_cast<T*>(lhs)->longitude = *static_cast<const CORBA::Double*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "altitude") == 0) {
      static_cast<T*>(lhs)->altitude = *static_cast<const CORBA::Double*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct TestA::DataB)");
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "latitude") == 0) {
      return static_cast<const T*>(lhs)->latitude == static_cast<const T*>(rhs)->latitude;
    }
    if (std::strcmp(field, "longitude") == 0) {
      return static_cast<const T*>(lhs)->longitude == static_cast<const T*>(rhs)->longitude;
    }
    if (std::strcmp(field, "altitude") == 0) {
...
{
  static MetaStructImpl<TestA::DataB> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<TestA::DataB>().getValue(ser, "");
  return true;
}
